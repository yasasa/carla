...
_CONTROL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='agent_control', full_name='carla_server.Control.agent_control', index=5,
...
_CONTROL.fields_by_name['agent_control'].message_type = _AGENTCONTROL
